...
stylesheet 'objects/_partition-object.scss'
stylesheet 'objects/_button-object.scss'
stylesheet 'objects/_media-object.scss'
stylesheet 'objects/_nav-object.scss'
...
stylesheet 'components/_tabs.scss'
stylesheet 'components/_icons.scss'
stylesheet 'components/_spacers.scss'
stylesheet 'components/_typography.scss'
stylesheet 'components/_close.scss'
stylesheet 'components/_buttons.scss'
